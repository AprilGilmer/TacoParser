    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < locations.Count(); i++) 
            {
                ...
                // TODO: Once you have locA, create a new GeoCoordinate object called `corA` with your locA's latitude and longitude.
            ...
            // Once you've looped through everything, you've found the two Taco Bells fa rthest away from each other.
            // Display these two Taco Bell locations to the console.

            logger.LogInfo($"{tacobellOne.Name}, {tacobellTwo.Name} with a distance of {distance}.");
        }
    }
}